            ...
            "initialize" => {
                success(id, json!({
                    ...
                    "serverInfo": {
                        ...
                        "icons": [{
                            "src": "data:image/svg+xml;base64,",
...
pub fn status() -> Result<String, String> {
    ...
    if !installed {
        lines.push(String::new());
        lines.push("Run 'geniuz mcp install' to connect to Claude Desktop.".to_string());
    }
